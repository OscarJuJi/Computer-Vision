...
for i = 1:num_blocks_vert
    for j = 1:num_blocks_horiz
        ...
        predicted_blocks(row_start:row_end, col_start:col_end) =uint8(predicted_block);

        error_block=uint8(block)-uint8(predicted_block);
        ...
        resultante(row_start:row_end, col_start:col_end)=(uint8(round(inverse_blocks(row_start:row_end, col_start:col_end)+double(predicted_blocks(row_start:row_end, col_start:col_end)),2)));
    end
end
